...
//		codeMap.put("01", new OperationStructure("01", InstrucionType.I21, 3, "LXI", "BC", "D16", "B<- byte3,C<- byte2"));
		codeMap.put("00", new OperationStructure("00", InstrucionType.I00, 1, "NOP", "", "", ""));
		codeMap.put("01", new OperationStructure("01", InstrucionType.I21, 3, "LXI", "B", "D16", "B<- byte3,C<- byte2"));
		codeMap.put("02", new OperationStructure("02", InstrucionType.I01, 1, "STAX", "B", "", "(BC)<-A"));
		...
		codeMap.put("09", new OperationStructure("09", InstrucionType.I01, 1, "DAD", "B", "", "HL = HL + BC"));
		codeMap.put("0A", new OperationStructure("0A", InstrucionType.I01, 1, "LDAX", "B", "", "A<-(BC)"));
		...
		codeMap.put("12", new OperationStructure("12", InstrucionType.I01, 1, "STAX", "D", "", "(DE)<-A"));
		...
		codeMap.put("19", new OperationStructure("19", InstrucionType.I01, 1, "DAD", "D", "", "HL = HL + DE"));
		codeMap.put("1A", new OperationStructure("1A", InstrucionType.I01, 1, "LDAX", "D", "", "A<-(DE)"));
		...
		codeMap.put("22", new OperationStructure("22", InstrucionType.I20A, 3, "SHLD", "addr", "", "(addr)<-L;(addr+1)<-H"));
		...
		codeMap.put("29", new OperationStructure("29", InstrucionType.I01, 1, "DAD", "H", "", "HL = HL + HL"));
		codeMap.put("2A", new OperationStructure("2A", InstrucionType.I20A, 3, "LHLD", "addr", "", "L<-(addr);H<-(addr+1)"));
		...
		codeMap.put("32", new OperationStructure("32", InstrucionType.I20A, 3, "STA", "addr", "", "(addr)<-A"));
		codeMap.put("33", new OperationStructure("33", InstrucionType.I01, 1, "INX", "SP", "", "SP<-SP + 1"));
		codeMap.put("34", new OperationStructure("34", InstrucionType.I01, 1, "INR", "M", "", "(HL)<-(HL)+1"));
		codeMap.put("35", new OperationStructure("35", InstrucionType.I01, 1, "DCR", "M", "", "(HL)<-(HL)-1"));
		codeMap.put("36", new OperationStructure("36", InstrucionType.I11, 2, "MVI", "M", "D8", "(HL)<-byte2"));
		...
		codeMap.put("39", new OperationStructure("39", InstrucionType.I01, 1, "DAD", "SP", "", "HL = HL + SP"));
		codeMap.put("3A", new OperationStructure("3A", InstrucionType.I20A, 3, "LDA", "addr", "", "A<-(addr)"));
		...
		codeMap.put("46", new OperationStructure("46", InstrucionType.I02, 1, "MOV", "B", "M", "B <- M"));
		...
		codeMap.put("4E", new OperationStructure("4E", InstrucionType.I02, 1, "MOV", "C", "M", "C <- M"));
		...
		codeMap.put("56", new OperationStructure("56", InstrucionType.I02, 1, "MOV", "D", "M", "D <- M"));
		...
		codeMap.put("5E", new OperationStructure("5E", InstrucionType.I02, 1, "MOV", "E", "M", "E <- M"));
		...
		codeMap.put("66", new OperationStructure("66", InstrucionType.I02, 1, "MOV", "H", "M", "H <- M"));
		...
		codeMap.put("6E", new OperationStructure("6E", InstrucionType.I02, 1, "MOV", "L", "M", "L <- M"));
		codeMap.put("6F", new OperationStructure("6F", InstrucionType.I02, 1, "MOV", "L", "A", "L <- A"));
		//
		codeMap.put("70", new OperationStructure("70", InstrucionType.I02, 1, "MOV", "M", "B", "M <- B"));
		codeMap.put("71", new OperationStructure("71", InstrucionType.I02, 1, "MOV", "M", "C", "M <- C"));
		codeMap.put("72", new OperationStructure("72", InstrucionType.I02, 1, "MOV", "M", "D", "M <- D"));
		...
		codeMap.put("7E", new OperationStructure("7E", InstrucionType.I02, 1, "MOV", "A", "M", "A <- M"));
		codeMap.put("7F", new OperationStructure("7F", InstrucionType.I02, 1, "MOV", "A", "A", "A <- A"));
		//
		codeMap.put("80", new OperationStructure("80", InstrucionType.I01, 1, "ADD", "B", "", "A <- A+B"));
		codeMap.put("81", new OperationStructure("81", InstrucionType.I01, 1, "ADD", "C", "", "A <- A+C"));
		codeMap.put("82", new OperationStructure("82", InstrucionType.I01, 1, "ADD", "D", "", "A <- A+D"));
		codeMap.put("83", new OperationStructure("83", InstrucionType.I01, 1, "ADD", "E", "", "A <- A+E"));
		codeMap.put("84", new OperationStructure("84", InstrucionType.I01, 1, "ADD", "H", "", "A <- A+H"));
		codeMap.put("85", new OperationStructure("85", InstrucionType.I01, 1, "ADD", "L", "", "A <- A+L"));
		codeMap.put("86", new OperationStructure("86", InstrucionType.I01, 1, "ADD", "M", "", "A <- A+M"));
		codeMap.put("87", new OperationStructure("87", InstrucionType.I01, 1, "ADD", "A", "", "A <- A+A"));
		//
		codeMap.put("88", new OperationStructure("88", InstrucionType.I01, 1, "ADC", "B", "", "A <- A+B + CY"));
		codeMap.put("89", new OperationStructure("89", InstrucionType.I01, 1, "ADC", "C", "", "A <- A+C + CY"));
		codeMap.put("8A", new OperationStructure("8A", InstrucionType.I01, 1, "ADC", "D", "", "A <- A+D + CY"));
		codeMap.put("8B", new OperationStructure("8B", InstrucionType.I01, 1, "ADC", "E", "", "A <- A+E + CY"));
		codeMap.put("8C", new OperationStructure("8C", InstrucionType.I01, 1, "ADC", "H", "", "A <- A+H + CY"));
		codeMap.put("8D", new OperationStructure("8D", InstrucionType.I01, 1, "ADC", "L", "", "A <- A+L + CY"));
		codeMap.put("8E", new OperationStructure("8E", InstrucionType.I01, 1, "ADC", "M", "", "A <- A+M + CY"));
		codeMap.put("8F", new OperationStructure("8F", InstrucionType.I01, 1, "ADC", "A", "", "A <- A+A + CY"));
		//
		...
		codeMap.put("96", new OperationStructure("96", InstrucionType.I01, 1, "SUB", "M", "", "A <- A-M"));
		codeMap.put("97", new OperationStructure("97", InstrucionType.I01, 1, "SUB", "A", "", "A <- A-A"));
		//
		codeMap.put("98", new OperationStructure("98", InstrucionType.I01, 1, "SBB", "B", "", "A <- A-B - CY"));
		codeMap.put("99", new OperationStructure("99", InstrucionType.I01, 1, "SBB", "C", "", "A <- A-C - CY"));
		codeMap.put("9A", new OperationStructure("9A", InstrucionType.I01, 1, "SBB", "D", "", "A <- A-D - CY"));
		codeMap.put("9B", new OperationStructure("9B", InstrucionType.I01, 1, "SBB", "E", "", "A <- A-E - CY"));
		codeMap.put("9C", new OperationStructure("9C", InstrucionType.I01, 1, "SBB", "H", "", "A <- A-H - CY"));
		codeMap.put("9D", new OperationStructure("9D", InstrucionType.I01, 1, "SBB", "L", "", "A <- A-L - CY"));
		codeMap.put("9E", new OperationStructure("9E", InstrucionType.I01, 1, "SBB", "M", "", "A <- A-M - CY"));
		codeMap.put("9F", new OperationStructure("9F", InstrucionType.I01, 1, "SBB", "A", "", "A <- A-A - CY"));
		//
		...
		codeMap.put("A6", new OperationStructure("A6", InstrucionType.I01, 1, "ANA", "M", "", "A <- A&M"));
		...
		codeMap.put("AE", new OperationStructure("AE", InstrucionType.I01, 1, "XRA", "M", "", "A <- A^M"));
		...
		codeMap.put("B6", new OperationStructure("B6", InstrucionType.I01, 1, "ORA", "M", "", "A <- A|M"));
		...
		codeMap.put("BE", new OperationStructure("BE", InstrucionType.I01, 1, "CMP", "M", "", "A - M"));
		...
		codeMap.put("C2", new OperationStructure("C2", InstrucionType.I20, 3, "JNZ", "addr", "", "if NZ,PC<-addr",PCaction.CONTINUATION));
		...
		codeMap.put("C6", new OperationStructure("C6", InstrucionType.I10, 2, "ADI", "D8", "", "A<-A + byte2"));
		codeMap.put("C7", new OperationStructure("C7", InstrucionType.I01, 1, "RST", "0", "", "CALL $0",PCaction.CONTINUATION));
		...
		codeMap.put("E9", new OperationStructure("E9", InstrucionType.I01, 1, "PCHL", "M", "", "PC.hi<-H;PC.lo<-L", PCaction.TOTAL));
