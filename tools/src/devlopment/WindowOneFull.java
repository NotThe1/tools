...
public class WindowOneFull implements ActionListener, MouseListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WindowOneFull window = new WindowOneFull();
	...
	private void initialize() {
		...
		frmTestHarness.setBounds(100, 100, 696, 579);
		...
		scrollPane.setBounds(336, 0, 340, 517);
