...
//			pattern.matches(txtRegexCode.getText(), input)
	...
	private void doReplaceFirst(){
		cleanOutput();
		
		Pattern pattern = Pattern.compile(txtRegexCode.getText());
		Matcher matcher = pattern.matcher(txtSourceString.getText());

		String ans = matcher.replaceFirst(txtReplacement.getText());
		
		String codeString= txtRegexCode.getText();
		String original = txtSourceString.getText();
		String replacement = txtReplacement.getText();
		String newString = original.replaceFirst(codeString, replacement);
		System.out.printf("[doReplaceFirst] newString: %s%n", newString);
		System.out.printf("[doReplaceFirst] ans: %s%n", ans);
	}//doReplaceFirst
	...
	private void doReplaceAll(){
		...
		String ans = matcher.replaceAll(txtReplacement.getText());
...
//---------------------------------------------------------
	...
	private void postLogMessage(String logMessage0) {
		String logMessage = String.format("%s \t%s - \t%s%n", logMessage0, txtSourceString.getText(), txtRegexCode.getText());
...
//		System.out.printf("[showGroup] afterGroup: %s%n", afterGroup);
		try {
			...
			doc.insertString(doc.getLength(), group, attrRed);
...
//........................................................................
	...
	private void initialize() {
		...
		gbl_panelLeft.rowHeights = new int[]{ 0, 0, 0, 0, 0, 10, 0, 0, 0, 25, 0, 0, 0};
		...
		btnLookingAt.setToolTipText("Attempts to match the input sequence, starting at the beginning of the region, against the pattern.");
		...
		btnReplaceFirst.setToolTipText("Replaces the first subsequence of the input sequence that matches the pattern with the given replacement string.");
		...
		btnReplaceAll.setToolTipText("Replaces every subsequence of the input sequence that matches the pattern with the given replacement string.");
		...
		gbc_txtReplacement.insets = new Insets(0, 0, 5, 0);
		gbc_txtReplacement.gridx = 1;
		gbc_txtReplacement.gridy = 11;
		panelLeft.add(txtReplacement, gbc_txtReplacement);
