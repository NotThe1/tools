...
public class OpCodeMap8080 {

	public OpCodeMap8080() {
	}// Constructor

	static public OperationStructure getOperationStructure(String key) {
	...
	static public OperationStructure get(String index) {
		return getOperationStructure(index);
	}// get

	static public int getOpCodeSize(String opCodeMapKey) {
		return codeMap.get(opCodeMapKey).getSize();
	}// getSize

	// ----------------------------------------------------------

	private static HashMap<String, OperationStructure> codeMap;
	...
	static {
		...
		//
		codeMap.put("C0", new OperationStructure("C0", InstrucionType.I01, 1, "RNZ", "NZ", "", "if NZ, (PC)<-(SP)"));
		codeMap.put("C1", new OperationStructure("C1", InstrucionType.I01, 1, "POP", "BC", "", "(BC<-(SP)"));
		codeMap.put("C2", new OperationStructure("C2", InstrucionType.I21, 3, "JNZ", "NZ", "D16", "if NZ,PC<-D16",PCaction.CONTINUATION));
		codeMap.put("C3", new OperationStructure("C3", InstrucionType.I20, 3, "JMP", "D16", "", "PC<-D16",PCaction.TOTAL));
		codeMap.put("C4", new OperationStructure("C4", InstrucionType.I21, 3, "CNZ", "NZ", "D16",
		...
		codeMap.put("C8", new OperationStructure("C8", InstrucionType.I01, 1, "RZ", "", "", "if Z set, PC<-(SP); SP<-SP+2"));
		codeMap.put("C9", new OperationStructure("C9", InstrucionType.I00, 1, "RET", "", "", "PC<-(SP); SP<-SP+2",PCaction.CONTINUATION));
		codeMap.put("CA", new OperationStructure("CA", InstrucionType.I21, 3, "JZ", "", "D16", "if Z set,PC<-D16",PCaction.CONTINUATION));
		codeMap.put("CB", new OperationStructure("CB", InstrucionType.I00, 1, "ALT", "", "", "NOP"));
		codeMap.put("CC", new OperationStructure("CC", InstrucionType.I21, 3, "CZ", "", "D16", "if Z,CALL D16", PCaction.CONTINUATION));
		...
		//
		codeMap.put("D0", new OperationStructure("D0", InstrucionType.I01, 1, "RNC", "", "", "if CY not set, (PC)<-(SP)"));
		codeMap.put("D1", new OperationStructure("D1", InstrucionType.I01, 1, "POP", "DE", "", ""));
		codeMap.put("D2", new OperationStructure("D2", InstrucionType.I21, 3, "JNC", "", "D16", "if CY not set,PC<-D16", PCaction.CONTINUATION));
		codeMap.put("D3", new OperationStructure("D3", InstrucionType.I12, 2, "OUT", "D8", "A", "OUT  (D8),A   I/O")); // Special
		codeMap.put("D4", new OperationStructure("D4", InstrucionType.I21, 3, "CNC", "", "D16", "if CY not set,CALL D16", PCaction.CONTINUATION));
		...
		codeMap.put("D8", new OperationStructure("D8", InstrucionType.I01, 1, "RC", "", "", "if CY  set,PC<-(SP)"));
		codeMap.put("D9", new OperationStructure("D9", InstrucionType.I00, 1, "RET", "", "", "**PC<-(SP); SP<-SP+2",PCaction.CONTINUATION));
		codeMap.put("DA", new OperationStructure("DA", InstrucionType.I21, 3, "JC", "", "D16", "if CY  set,PC<-D16", PCaction.CONTINUATION));
		codeMap.put("DB", new OperationStructure("DB", InstrucionType.I16, 2, "IN", "A", "D8", "i/O")); // Special
		codeMap.put("DC", new OperationStructure("DC", InstrucionType.I21, 3, "CC", "", "D16","if CY set ,(SP)<-PC,PC<- address", PCaction.CONTINUATION));
		...
		//
		codeMap.put("E0", new OperationStructure("E0", InstrucionType.I01, 1, "RPO", "", "", "if P is reset, set,PC<-(SP)"));
		codeMap.put("E1", new OperationStructure("E1", InstrucionType.I01, 1, "POP", "HL", "", ""));
		codeMap.put("E2", new OperationStructure("E2", InstrucionType.I21, 3, "JPO", "", "D16", "if P is reset,PC<-D16", PCaction.CONTINUATION));
		codeMap.put("E3", new OperationStructure("E3", InstrucionType.I02, 1, "XTHL", "(SP)", "HL", "L<->(SP);H<->(SP+1)"));
		codeMap.put("E4", new OperationStructure("E4", InstrucionType.I21, 3, "CPO", "", "D16","if P is reset,(SP)<-PC,PC<- address", PCaction.CONTINUATION));
		...
		codeMap.put("E8", new OperationStructure("E8", InstrucionType.I01, 1, "RPE", "", "", "if P is set, set,PC<-(SP)"));
		codeMap.put("E9", new OperationStructure("E9", InstrucionType.I01, 1, "PCHL", "(HL)", "", "PC.hi<-H;PC.lo<-L", PCaction.TOTAL));
		codeMap.put("EA", new OperationStructure("EA", InstrucionType.I21, 3, "JPE", "", "D16", "if P is set,PC<-D16", PCaction.CONTINUATION));
		codeMap.put("EB", new OperationStructure("EB", InstrucionType.I02, 1, "XCHG", "DE", "HL", "H<->D;L<->E")); // Special
		codeMap.put("EC", new OperationStructure("EC", InstrucionType.I21, 3, "CPE", "", "D16","if P is set,(SP)<-PC,PC<- address", PCaction.CONTINUATION));
		...
		//
		codeMap.put("F0", new OperationStructure("F0", InstrucionType.I01, 1, "RP", "", "", "if S rest, set,PC<-(SP)"));
		codeMap.put("F1", new OperationStructure("F1", InstrucionType.I01, 1, "POP", "AF", "","flags<-(SP);A<-(SP+1); SP<-SP+2"));
		codeMap.put("F2", new OperationStructure("F2", InstrucionType.I21, 3, "JP", "", "D16", "if S reset,PC<-D16", PCaction.CONTINUATION));
		codeMap.put("F3", new OperationStructure("F3", InstrucionType.I00, 1, "DI", "", "", "Disable interrups"));
		codeMap.put("F4", new OperationStructure("F4", InstrucionType.I21, 3, "CP", "", "D16","if S reset,(SP)<-PC,PC<- address", PCaction.CONTINUATION));
		...
		codeMap.put("F8", new OperationStructure("F8", InstrucionType.I01, 1, "RM", "", "", "if S set, set,PC<-(SP)"));
		codeMap.put("F9", new OperationStructure("F9", InstrucionType.I02, 1, "SPHL", "SP", "HL", "SP<-HL"));
		codeMap.put("FA", new OperationStructure("FA", InstrucionType.I21, 3, "JM", "", "D16", "if S set,PC<-D16", PCaction.CONTINUATION));
		codeMap.put("FB", new OperationStructure("FB", InstrucionType.I00, 1, "EI", "", "", "Enable interrupts"));
		codeMap.put("FC", new OperationStructure("FC", InstrucionType.I21, 3, "CM", "", "D16","if S set,(SP)<-PC,PC<- address", PCaction.CONTINUATION));
