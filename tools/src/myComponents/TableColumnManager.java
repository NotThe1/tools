 ...
 * of the table. The TableColumnModel is still used to control the view for the table. The manager will inovoke the
...
public class TableColumnManager
	...
	/**
	 * Convenience constructor for creating a TableColumnManager for a table. Support for a popup menu on the table
	 * header will be enabled.
	 *
	 * @param table
	 ...
	 *            the table whose TableColumns will managed.
	 * @param menuPopup
	 *            enable or disable a popup menu to allow the users to manager the visibility of TableColumns.
	 */
	 ...
	 *
	 * @param menuPopop
	 *            when true support for displaying a popup menu is added otherwise the popup menu is removed.
	 */
	 ...
	 *
	 * @param column
	 *            the TableColumn to be removed from the TableColumnModel of the table
	 */
